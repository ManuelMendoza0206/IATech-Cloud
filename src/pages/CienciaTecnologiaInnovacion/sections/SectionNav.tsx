...
const SECTIONS = [
  { id: 'ciencia', label: 'Ciencia', short: '01' },
  { id: 'tecnologia', label: 'Tecnología', short: '02' },
  { id: 'innovacion', label: 'Innovación', short: '03' },
  { id: 'interseccion', label: 'Intersección', short: '04' },
...
export default function SectionNav() {
  const [active, setActive] = useState<string>('ciencia');
