...
//import GestionTecnologias from './pages/GestionTecnologias/GestionTecnologias';
...
//  { path: '/gestion-tecnologias', label: 'Gestión de Tecnologías', element: <GestionTecnologias /> },
